...
GEÄNDERT	= TAG 23-07-11  ZEIT 04:05:52;
DATEI_NAME	= UP021;
VERSION		= 0;
ZEILEN		= 24;
SPEICHERGR.	= 8712;
...
/MN
   ...
   8:J P[1] 100% CNT0 ACC100 ZEIT VOR    .10sek,P-SPS    ;
     ...
     48:  FB-PSPS (E[79] [&] E[80] [&] M[2] [&] M[10] [&] M[11] [&] M[13] [&] M[30] [&] M[31] [&] M[39]) ;
       ------ ;
   9:J P[2] 100% CNT100 ACC100 ZEIT VOR   0.00sek,P-SPS    ;
      1:  FB-PSPS (E[79] [&] E[80] [&] M[2] [&] M[10] [&] M[11] [&] M[13] [&] M[30] [&] M[31] [&] M[39]) ;
       ------ ;
  10:J P[3] 100% CNT100 ACC100 ZEIT VOR   0.00sek,P-SPS    ;
      1:  FB-PSPS (E[79] [&] E[80] [&] M[2] [&] M[10] [&] M[11] [&] M[13] [&] M[30] [&] M[31] [&] M[39]) ;
       ------ ;
  11:J P[4] 100% CNT100 ACC100 ZEIT VOR   0.00sek,P-SPS    ;
      1:  FB-PSPS (E[79] [&] E[80] [&] M[10] [&] M[11] [&] M[13] [&] M[30] [&] M[31] [&] M[39]) ;
       ------ ;
  ...
  24:J P[9] 100% CNT0 ACC100 ZEIT VOR    .10sek,P-SPS    ;
      ...
      8:  WARTE (E[23])    ;
      9:  A[23]=AN ;
     10:  FB-PSPS (M[3] [&] M[30] [&] M[32] [&] M[33] [&] M[35] [&] M[37] [&] M[39] [&] M[41]) ;
       ------ ;
/POS
P[1]{
   GP1:
...
P[5]{
   GP1:
	UF : 0, UT : 1,		KONFIG : 'N U T, 0, 0, 0',
	X =  1986.203  mm,	Y =   622.625  mm,	Z =  -162.658  mm,
	W =   176.584 deg,	P =    89.084 deg,	R =    18.823 deg
   GP2:
	UF : 0, UT : 1,	
	J1=     0.000  mm
   GP3:
