...
/ATTR
EIGN.		= MNEDITOR;
KOMMENTAR	= "EQ EZSP3 TIN";
PROG_GRÖßE	= 1101;
ERSTELL		= TAG 11-08-17  ZEIT 09:38:16;
...
/MN
   ...
   5:  IRQ BEDINGUNG E[1038]=AN [+] A[22855]=AN    ;
   6:  A[1035]=AN ;
  ...
  21:  WARTE A[1030]=AUS [+] A[22855]=AN    ;
  22:  AUFRUF EQGUNOPN    ;
  23:  AUFRUF EQEND    ;
  24:  ! Set pos for gun opening motion ;
  25:  //AUFRUF EQTCHPOS('MOTN035',1,1,(-3)) ;
  26:  OVERRIDE=i[820] ;
  27:  i[819]=A[22902]    ;
